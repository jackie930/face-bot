...
if [ "$image" == "" ]
then
    echo "Use image name insightface-sagemaker-inference"
    image="insightface-sagemaker-inference"
fi
...
aws s3 cp s3://aws-solutions-henanwan-cn-northwest-1/spot-bot-models/face/model.tar.gz ./
